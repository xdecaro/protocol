...
?>
<form action="<?php echo Route::_('index.php?option=com_decaroprotocol&view=records'); ?>" method="post" name="adminForm" id="adminForm" class="xdecaro-scope decaroprotocol-admin">
